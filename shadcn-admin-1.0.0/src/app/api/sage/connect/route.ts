...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const defaultScopes = cfg.scopes?.join(" ") || "full_access";
    ...
    const authorize = new URL("https://www.sageone.com/oauth2/auth/central");
    ...
    res.cookies.set("sage_oauth_state", state, cookie);
    res.cookies.set("sage_pkce_verifier", verifier, cookie);
    res.cookies.set("sage_client_id", clientId, cookie);
    res.cookies.set("sage_redirect_uri", redirectUri, cookie);
